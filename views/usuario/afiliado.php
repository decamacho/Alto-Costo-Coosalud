<div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h3>Afiliados Programa Coosalud</h3>
                                <small>Usuarios ingresados a programa y CUENTA DE ALTO COSTO para seguimiento</small>
                                ...
                                <div class="main-card mb-3 card">
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($afiliados as $afiliado) : ?>
                                                            <tr>
                                                                <td><?php echo $afiliado->tipod?><?php echo $afiliado->documento?></td>
                                                                ...
                                                                <td>
                                                                    <a href="?controller=persona&method=detail&program=<?php echo $afiliado->id_persona ?>"><i class="material-icons">add_circle_outline</i></a>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="add">
                                            <div class="body">
                                                <h4 class="card-inside-title">Agregar Afiliado</h4>
